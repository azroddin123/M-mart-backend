                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            <img class="img--120" id="viewer"
                                                src="{{asset('storage/store').'/'.$store->logo}}" alt="{{$store->name}}" onerror='this.src="{{asset('public/assets/admin/img/400x400/img2.jpg')}}"'/>
                                        </center>
...
<script>
    ...
    <script>
        $('#reset_btn').click(function(){
            $('#viewer').attr('src', "{{asset('storage/store').'/'.$store->logo}}");
            $('#customFileEg1').val(null);
            $('#coverImageViewer').attr('src', "{{asset('storage/store/cover/'.$store->cover_photo)}}");
