                                        ...
                                        <div class="row h-100">
                                            <div class="col-sm-6">
                                                <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                    ...
                                                    <center class="my-auto py-3">
                                                        <img class="initial--15 " id="viewer" onerror="this.src='{{asset('public/assets/admin/img/400x400/img2.jpg')}}'" src="{{asset('storage/module/'.$module['icon'])}}" alt="image" />
                                                    </center>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                    ...
                                                    <center class="my-auto py-3">
                                                        <img class="initial--15 " id="viewer2" onerror="this.src='{{asset('public/assets/admin/img/400x400/img2.jpg')}}'" src="{{asset('storage/module/'.$module['thumbnail'])}}" alt="image" />
                                                    </center>
                                                    <div class="custom-file">
