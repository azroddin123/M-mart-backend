...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                'item_image_url' => asset('storage/product'),
                'refund_image_url' => asset('storage/refund'),
                ...
                'store_cover_photo_url' => asset('storage/store/cover'),
                ...
                'order_attachment_url' => asset('storage/order'),
                'module_image_url' => asset('storage/module'),
                'parcel_category_image_url' => asset('storage/parcel_category'),
